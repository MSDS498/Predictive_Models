...
y_act <- testData$review_logistic
...
up_data2=up_train2%>%select("d_late","status","product_description_lenght","total_delivery_time","total_price",
                            "freight_to_price_ratio","cluster_com","review_logistic")

test_data2=testData2%>%select("d_late","status","product_description_lenght","total_delivery_time","total_price",
                              "freight_to_price_ratio","cluster_com","review_logistic")
...
pred <- predict(logitmod2, newdata = test_data2, type = "response")
